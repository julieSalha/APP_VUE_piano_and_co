  ...
  <section class="music-player">
      <div id="flat-black-player-container">
        <div id="list-screen" class="slide-in-top">
          <div id="list-screen-header" class="hide-playlist" @click="hidePlayList">
        ...
        <div id="player-screen">
          <div class="player-header down-header" @click="openPlayList">
          ...
          <div id="player-progress-bar-container">
            <progress id="song-played-progress" class="amplitude-song-played-progress" @click="percentSong"></progress>
...
export default {
  ...
  methods: {
    ...
    openPlayList: function () {
      ...
      this.list.style.height = ( parseInt( document.getElementById('flat-black-player-container').offsetHeight ) - 135 ) + 'px';
      document.getElementById('list-screen').classList.remove('slide-out-top');
      document.getElementById('list-screen').classList.add('slide-in-top');
      document.getElementById('list-screen').style.display = "block";
    },
    hidePlayList: function () {
      console.log('hidePlayList');
      document.getElementById('list-screen').classList.remove('slide-in-top');
      document.getElementById('list-screen').classList.add('slide-out-top');
      document.getElementById('list-screen').style.display = "none";
    },
    percentSong: function (event) {
      //console.log(event.target, 'event.target');
      console.log('percentSong');
      this.offset = event.target.getBoundingClientRect();
      this.x = event.target.pageX - this.offset.left;
      Amplitude.setSongPlayedPercentage( ( parseFloat( this.x ) / parseFloat( this.offsetWidth) ) * 100 );
